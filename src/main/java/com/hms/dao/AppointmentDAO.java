...
public class AppointmentDAO {
	...
	public boolean addAppointment(Appointment appointment) {
		...
		try {
			...
			String value=appointment.getStatus();
			String encrypt = "";
			int secret_key = 8;
	...
	public List<Appointment> getAllAppointmentByLoginUser(int userId) {
		...
		try {
			...
			while (resultSet.next()) {
				...
				String va=resultSet.getString(12);
				int secret_key = 8;
				String b = "";
	...
	public List<Appointment> getAllAppointmentByLoginDoctor(int doctorId) {
		...
		try {
			...
			while (resultSet.next()) {
				...
				appointment.setStatus(decrypted);
				appList.add(appointment);
	...
	public Appointment getAppointmentById(int id) {
		...
		try {
			...
			while (resultSet.next()) {
				...
				appointment.setDoctorId(resultSet.getInt(10));
				appointment.setAddress(resultSet.getString(11));
				String val=resultSet.getString(12);
				int secret_key = 8;
				String z = "";
	...
	public boolean updateDrAppointmentCommentStatus(int apptId, int docId, String comment) {
		...
		try {
			...
			pstmt.setString(1, DigestUtils.sha256Hex(x));
	...
	public List<Appointment> getAllAppointment() {
		...
		try {
			...
			while (resultSet.next()) {
				...
				appointment.setDoctorId(resultSet.getInt(10));
				appointment.setAddress(resultSet.getString(11));
				String valu=resultSet.getString(12);
				int secret_key = 8;
				String a = "";
